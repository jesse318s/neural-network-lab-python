...
class TestAdaptiveLoss(unittest.TestCase):
    ...
    def test_adaptive_loss_get_weights(self):
        ...
        mse_weight_fancy, mae_weight_fancy = compute_loss_weights('curve_fancy')
        ...
        self.assertAlmostEqual(mse_weight_fancy + mae_weight_fancy, 1.0)
